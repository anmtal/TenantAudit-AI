-- ====================================================================
-- LeaseAlign AI Consolidated Database Setup (with Teams)
-- ====================================================================
...
-- --------------------------------------------------------------------
-- 6. Legacy Data Migration (Converts old users to Teams)
-- --------------------------------------------------------------------
DO $$
DECLARE
  prof RECORD;
...
-- --------------------------------------------------------------------
-- 7. Safe Credit Deduction RPC Helper
-- --------------------------------------------------------------------
...
BEGIN
  IF plan_mode = 'hosted' THEN
    -- In new team-based logic, this legacy helper might not work without team context. 
    -- Left here for backward compatibility with older frontend if any.
...
-- --------------------------------------------------------------------
-- 7b. Server-Side Atomic Credits Deduction & Refund (Race-Condition Free)
-- --------------------------------------------------------------------
...
-- --------------------------------------------------------------------
-- 8. Team Membership RPC (for inviting users)
-- --------------------------------------------------------------------
